    ...
    <div class="page-content-wrapper">
        ...
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-helper">Menü Ekleme</span>
            </div>
        ...
        <div class="portlet-body form">
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                  <label class="col-md-2 control-label">Menü</label>
                  <div class="col-md-10">
                  ...
                  <div class="col-md-10">
                      <select class="form-control bs-select" name="icon" data-show-subtext="true">
                        <?php foreach ($db->get_results("SELECT * from yetki_sayfa_icon ORDER BY icon ASC ") as $value) {?>
                          <option value="<?=$value->icon?>"  data-icon="<?=$value->icon?>"><?=$value->icon?></option>
                        <?php }?>
                      </select>
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-10">
                      <select class="form-control kategoriler" name="type">
                          ...
                          <option value="duzenle">Düzenle</option>
                          <option value="listele">Listele</option>
                      </select>
                  </div>
              </div>
                        ...
                        <div class="col-md-10">
                            <div class="btn-group btn-toggle" data-toggle="buttons">
                             <label class="btn btn-default btn-primary active">
                               <input type="radio" name="goster" value="1" checked> Göster
                             </label>
                             <label class="btn btn-default">
                               <input type="radio" name="goster" value="2"> Gösterme
                             </label>
                           </div>
                        </div>
                    </div>
