...
<div class="page-container">
    ...
    $gelenid = $_GET["id"];
    $row = $db->get_row("SELECT * from kullanici WHERE id = {$gelenid} ");
    ?>
    <!-- END SIDEBAR -->
    ...
    <div class="page-content-wrapper">
        ...
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-helper">Yönetici Düzenleme</span>
            </div>
            ...
            <div class="actions btn-set">
                ...
                <button class="btn green-haze btn-circle" onclick="islemDuzenle('yoneticiController','Duzenle','<?=$gelenid?>','anasayfa.php');  return false"><i class="fa fa-check"></i> Kaydet</button>
            </div>
        </div>
        <div class="portlet-body form">
            ...
            <div class="form-body">
              ...
              <?php
              if($_SESSION["yetki"] == 16 || $_SESSION["yetki"] == 99){?>
                  ...
                  <div class="col-md-10">
                      <select class="form-control kategoriler" name="yetki">
                        <?php foreach ($db->get_results("SELECT * from yetkiler WHERE yetki != 16 ORDER BY adi ASC ") as $value) {?>
                          <option value="<?=$value->yetki?>" <?php if ($row->yetki == $value->yetki) { echo "selected";}?>><?=$value->adi?></option>
                        <?php }?>
                      </select>
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-10">
                      <input type="text" class="form-control" id="adsoyad" name="adsoyad" placeholder="Ad Soyad" value="<?=$row->adsoyad?>">
                  </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-10">
                      <input type="text" class="form-control" id="email" name="email" placeholder="E-posta" value="<?=$row->email?>">
                  </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-10">
                      <div class="btn-group btn-toggle" data-toggle="buttons">
                       <label class="btn btn-default <?php if ($row->durum == 1) { echo "btn-primary active";}?>">
                         <input type="radio" name="durum" value="1" <?php if ($row->durum == 1) { echo "checked";}?>> Göster
                       </label>
                       <label class="btn btn-default <?php if ($row->durum == 2) { echo "btn-primary active";}?>">
                         <input type="radio" name="durum" value="2" <?php if ($row->durum == 2) { echo "checked";}?>> Gösterme
                       </label>
                     </div>
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-10">
                      <input type="password" class="form-control" id="sifre" name="sifre" placeholder="Şifre Değiştir" value="">
                      <span class="help-block">Yalnızca şifre değişikliği yapmak istiyorsanız doldunuz. Aksi taktirde boş bırakınız.</span>
                  </div>
