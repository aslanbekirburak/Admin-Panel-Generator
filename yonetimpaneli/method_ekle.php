    ...
    <div class="page-content-wrapper">
        ...
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-helper">Method Ekleme</span>
            </div>
            ...
            <div class="actions btn-set">
                ...
                <button class="btn green-haze btn-circle" onclick="islemEkle('webserviceController','Ekle','0','method_listele.php');  return false"><i class="fa fa-check"></i> Kaydet</button>
            </div>
        </div>
        <div class="portlet-body form">
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-10">
                      <input type="text" class="form-control" maxlength="99" name="methodadi" placeholder="Method Adı" value="">
                  </div>
              </div>
