...
<div class="form-group">
                  <label class="col-md-2 control-label">ad: <span class="required">* </span></label>
                  <div class="col-md-10">
                      <input type="text" class="form-control" maxlength="99" id="123" name="ad" placeholder="ad" /*value="<?=$row->menuadi?>">
                  </div>
              </div>
<div class="form-group">
                                            <label class="col-md-2 control-label">de: <span class="required"> </span></label>
                                            <div class="col-md-10">
                                                <select class="form-control brans" name="bas" id="1234">
                                                <?php foreach ($db->get_results("SELECT * from yetki_sayfalar ORDER BY menuadi ASC ") as $value) {?>
                                                  <option value="<?=$value->menuadi?>"  data-icon="<?=$value->menuadi?>"><?=$value->menuadi?></option>
                                                <?php }?>
                                                </select>
                                            </div>
                                        </div>
  <div class="form-group">
                        <label class="control-label col-md-2">cins:</label>
                        <div class="col-md-10">
                            <div class="btn-group btn-toggle" data-toggle="buttons">
                             <label class="btn btn-default btn-primary active">
                               <input type="radio" name="cn" value="1" checked> erkek
                             </label>
                             <label class="btn btn-default">
                               <input type="radio" name="cn" value="0"> kadın
                             </label>
                           </div>
                        </div>
                    </div>
