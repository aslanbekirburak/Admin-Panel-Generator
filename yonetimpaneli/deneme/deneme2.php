...
<div class="form-group">
                                            <label class="col-md-2 control-label">deneme2: <span class="required"> </span></label>
                                            <div class="col-md-10">
                                                <select class="form-control brans" name="asdasdasd" id="123132">
...
<div class="form-group">
                                            <label class="col-md-2 control-label">denem3e: <span class="required"> </span></label>
                                            <div class="col-md-10">
                                                <select class="form-control brans" name="baslan" id="6789">
                                                <?php foreach ($db->get_results("SELECT * from yetki_sayfalar ORDER BY menuadi ASC ") as $value) {?>
                                                  <option value="<?=$value->menuadi?>"  data-icon="<?=$value->menuadi?>"><?=$value->menuadi?></option>
                                                <?php }?>
                                                </select>
