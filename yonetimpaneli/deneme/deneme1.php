...
<div class="form-group">
                  ...
                  <div class="col-md-10">
                      <input type="text" class="form-control" maxlength="99" id="123" name="ad" placeholder="ad giriniz" /*value="<?=$row->menuadi?>">*/
                  </div>
              </div>
  <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <div class="btn-group btn-toggle" data-toggle="buttons">
                             <label class="btn btn-default btn-primary active">
                               <input type="radio" name="gender" value="1" checked> erkek
                             </label>
                             <label class="btn btn-default">
                               <input type="radio" name="gender" value="0"> kadın
                             </label>
                           </div>
                        </div>
                    </div>
