    ...
    <div class="page-content-wrapper">
        ...
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-green-sharp bold uppercase">Men� Y�netimi </span>
                <span class="caption-helper">Men� Ekleme</span>
            </div>
...
<div class="form-group">
                  <label class="col-md-2 control-label">Menu Adi: <span class="required">* </span></label>
                  <div class="col-md-10">
                      <input type="text" class="form-control" maxlength="99" id="12345" name="aslan" placeholder="holdering" /*value="<?=$row->menuadi?>">*/
                  </div>
              </div>
  <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <div class="btn-group btn-toggle" data-toggle="buttons">
                             <label class="btn btn-default btn-primary active">
                               <input type="radio" name="menuler " value="val1" checked> lab1
                             </label>
                             <label class="btn btn-default">
                               <input type="radio" name="menuler " value="val2"> lab2
                             </label>
                           </div>
                        </div>
                    </div>
