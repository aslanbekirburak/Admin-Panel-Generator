...
<div class="form-group">
                  ...
                  <div class="col-md-10">
                      <input type="text" class="form-control" maxlength="99" id="88" name="input" placeholder="adınız" /*value="<?=$row->menuadi?>">
                  </div>
              </div>
<!--labelinput-->
<!--label{form_name}-->
                        ...
                        <div class="col-md-10">
                            <div class="btn-group btn-toggle" data-toggle="buttons">
                             <label class="btn btn-default btn-primary active">
                               <input type="radio" name="cinsiyet" value="e" checked> erkek
                             </label>
...
<!--label{label_name}-->
      <div class="form-group">
                      <label class="col-md-2 control-label">aslan: <span class="required"> </span></label>
                      <div class="col-md-10">
                          <select class="form-control brans" name="lll" id="kmkm">
