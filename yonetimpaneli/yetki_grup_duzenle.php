...
<div class="page-container">
    ...
    $gelenid = $_GET["id"];
    $row = $db->get_row("SELECT * from yetkiler WHERE id = {$gelenid} ");
    ?>
    <!-- END SIDEBAR -->
    ...
    <div class="page-content-wrapper">
        ...
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-helper">Yetki Grubu Düzenleme</span>
            </div>
            ...
            <div class="actions btn-set">
                ...
                <button class="btn green-haze btn-circle" onclick="islemDuzenle('yetkigrupController','Duzenle','<?=$gelenid?>','yetki_gruplari.php');  return false"><i class="fa fa-check"></i> Kaydet</button>
            </div>
        </div>
        <div class="portlet-body form">
            ...
            <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" maxlength="99" id="adi" name="adi" placeholder="Adı" value="<?=$row->adi?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="yetki" name="yetki" placeholder="Yetki No" value="<?=$row->yetki?>">
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            <select class="form-control kategoriler" name="erisilensayfalar[]" multiple>
                              ...
                              foreach ($db->get_results("SELECT * from yetki_sayfalar ORDER BY menuadi ASC ") as $value) {?>
                                <option value="<?=$value->id?>" <?php if (in_array($value->id,$sayfalar)) { echo "selected";}?>><?=$value->menuadi?></option>
                              <?php }?>
                            </select>
                        </div>
                    </div>
