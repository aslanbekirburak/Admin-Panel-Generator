...
<div class="form-group">
                  <label class="col-md-2 control-label">marka: <span class="required"> </span></label>
                  <div class="col-md-10">
                      <input type="text" class="form-control" maxlength="99" id="10" name="marka" placeholder="" /*value="<?=$row->menuadi?>">
                  </div>
              </div>
<!--labelmarka-->
<!--label{label_name}-->
      <div class="form-group">
                      <label class="col-md-2 control-label">ll: <span class="required"> </span></label>
                      <div class="col-md-10">
                          <select class="form-control brans" name="aylar" id="11">
                          <?php foreach ($db->get_results("SELECT * from months ORDER BY name ASC ") as $value) {?>
                            <option value="<?=$value->name?>"  data-icon="<?=$value->name?>"><?=$value->name?></option>
                          <?php }?>
                          </select>
                      </div>
                  </div>
